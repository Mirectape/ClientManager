...
{
    public class TopUpNonDepositAccountCommand : CommandBase
    {
        private readonly Repository _repository;
        private readonly BankWorkerViewModel _bankWorkerViewModel;
        private readonly NavigationService _navigationService;

        public TopUpNonDepositAccountCommand(Repository repository, BankWorkerViewModel bankWorkerViewModel,
        ...
        public override void Execute(object parameter)
        {
            ...
            {
                _bankWorkerViewModel.SelectedClient.NonDepositBankAccount.DepositMoney += _bankWorkerViewModel.TopUpSum;
                _bankWorkerViewModel.SelectedClient.ClientProtocol.TopUpInfo =
                    $"NonDeposit was topped up by Bank worker at {DateTime.Now} by {_bankWorkerViewModel.TopUpSum}";
